	...
	public override void OnInspectorGUI()
	{
		...
		if(!isMarker)
		{
			...
			switch(conditionType)
			{
				...
				case TimeMachineBehaviour.Condition.Conditional:
					EditorGUILayout.HelpBox("The above action will be executed depending upon the condition provider's logic.", MessageType.Info);
					EditorGUILayout.Space();
					EditorGUILayout.PropertyField(conditionProp);
					EditorGUILayout.PropertyField(serializedObject.FindProperty("conditionProvider"));
					break;
